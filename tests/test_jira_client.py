...
from jira_client import JiraClient, JiraAPIError, _check_retryable
...
def mock_env_vars(monkeypatch):
    ...
    monkeypatch.setenv("ALLOWED_DOMAINS", "repository.impact-initiatives.org,reach-initiative.atlassian.net")
...
def test_download_proforma_attachment_no_valid_attachments(client, tmp_path):
    attachments = [
        ...
        {"filename": "JIVE_Validation_Report_RQA-123.xlsx", "created": "2026-05-01T10:00:00.000+0000"},
    ]
...
def test_download_proforma_attachment_success(client, tmp_path):
    attachments = [
        {"filename": "old.xlsx", "content": "https://test/old.xlsx", "created": "2026-05-01T10:00:00.000+0000"},
        {"filename": "new.xlsx", "content": "https://test/new.xlsx", "created": "2026-05-02T10:00:00.000+0000"},
        {"filename": "JIVE_Validation_Report_RQA-123.xlsx", "content": "https://test/report.xlsx", "created": "2026-05-03T10:00:00.000+0000"},
    ]
...
def test_upload_public_jsm_attachment_success(client, tmp_path):
    ...
    responses.add(responses.GET, f"{client.base_url}/rest/servicedeskapi/servicedesk/RQA", json={"id": "5"}, status=200)
    
    # 2. upload temporary
    responses.add(responses.POST, f"{client.base_url}/rest/servicedeskapi/servicedesk/5/attachTemporaryFile", 
                  json={"temporaryAttachments": [{"temporaryAttachmentId": "temp-123"}]}, status=201)
    
    # 3. attach publicly
    responses.add(responses.POST, f"{client.base_url}/rest/servicedeskapi/request/RQA-123/attachment", 
                  json={}, status=201)
...
def test_upload_public_jsm_attachment_sd_id_failure(client, tmp_path):
    responses.add(responses.GET, f"{client.base_url}/rest/servicedeskapi/servicedesk/RQA", status=404)
    file_path = tmp_path / "report.xlsx"
    file_path.write_text("dummy content")
