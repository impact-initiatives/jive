...
from tests.helpers import make_attachment, make_issue_response
...
def mock_env_vars(monkeypatch):
    ...
    monkeypatch.setenv("ALLOWED_DOMAINS", "repository.impact-initiatives.org,domain.atlassian.net")
...
def test_download_from_secure_link_ssrf_empty_allowlist(client: JiraClient, tmp_path, monkeypatch):
    import jira.jira_client as jira_client
