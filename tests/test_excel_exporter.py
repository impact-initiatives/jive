...
def test_export_populated_response(tmp_path):
    response = PipelineResponse.model_construct(
        ...
        metadata={"dataset_type": "msna"},
        warnings=[
            {"severity": "warning", "rule": "W1", "message": "Warning msg", "sheet_name": "S1", "column_name": "C1"}
        ],
        errors=[
            {
                "severity": "error", 
        ...
        info=[
            {"severity": "info", "rule": "I1", "message": "Info msg"}
        ],
        admin_errors=[
            {"severity": "admin", "rule": "A1", "message": "Admin msg"}
        ]
    )
        ...
        errors=[
            {
                ...
                "rule": "E1", 
                "message": "Error msg", 
                "details": {"Row": 1, "Value": "a"}  # Not a list, should be caught by exception handling
            }
        ],
        warnings=[],
        info=[],
